...
<div class="intro-y flex items-center mt-8">
    <h2 class="text-lg font-medium mr-auto">
        Tambah PPKT Kecamatan {{ucwords(strtolower($kec->name))}}
    </h2>
</div>
...
<script>
    ...
    function submitItem(){
        Swal.fire({
            ...
            text: 'Anda akan menginput Data Pulau Pulau Kecil Terluar Kecamatan. Lanjutkan?',
