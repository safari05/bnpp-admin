...
<div class="intro-y flex items-center mt-8">
    <h2 class="text-lg font-medium mr-auto">
        {{ucwords($mode)}} Wilayah Desa {{ucwords(strtolower($desa->name))}}
    </h2>
</div>
            ...
            <div class="p-5">
                <form action="grid grid-cols-12 gap-6" id="form-input">
                    ...
                    <div class="col-span-12">
                        <label for="">Ibukota Desa</label>
                        <input type="text" class="input w-full border mt-2" placeholder="Ibukota Desa" name="ibukota" id="ibukota" value="{{@$wilayah->ibukota_desa}}">
                    </div>
                    <div class="col-span-12 mt-2">
                        <label for="">Luas Wilayah Desa (Km<sup>2</sup>)</label>
                    ...
                    <div class="col-span-6 mt-2">
                        <label for="">Jarak ke Kabupaten (Km)</label>
                        <input type="number" class="input w-full border mt-2" placeholder="Jarak Ke Kabupaten" name="jarakkab" id="jarakkab" value="{{@$wilayah->jarak_ke_kabupaten}}">
                    </div>
                    <div class="col-span-6 mt-2">
                        <label for="">Jarak Ke Kecamatan (Km)</label>
                        <input type="number" class="input w-full border mt-2" placeholder="Jarak Ke Kecamatan" name="jarakkec" id="jarakkec" value="{{@$wilayah->jarak_ke_kecamatan}}">
                    </div>
                    ...
                    <div class="col-span-6 mt-2" id="negara-holder">
...
<script>
    ...
    function submitItem(){
        Swal.fire({
            ...
            text: 'Anda akan menginput data Wilayah Desa. Lanjutkan?',
