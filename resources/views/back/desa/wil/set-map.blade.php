...
<div class="intro-y flex items-center mt-8">
    <h2 class="text-lg font-medium mr-auto">
        {{ucwords($mode)}} Lokasi Kantor Desa {{ucwords(strtolower($desa->name))}}
    </h2>
</div>
        ...
        <div class="intro-y box mt-5">
            <div class="flex items-center px-5 py-3 border-b border-gray-200 dark:border-dark-5">
                <h2 class="font-medium text-base mr-auto">
                    Pilih Lokasi Kantor Desa
                    <br>
                    <small>Geser pin ke lokasi kantor desa</small>
                </h2>
...
<script>
    ...
    function initMapDesa(){
        ...
        specialMarker = L.marker(coord, {
            icon:desaicon,
            draggable:true,
        }).bindPopup('<button type="button" class="button button--sm block bg-theme-1 text-white" onclick="submitMap()">Simpan Lokasi Kantor Desa</button>').addTo(map);
