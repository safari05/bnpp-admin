...
<div class="hidden xl:flex flex-col min-h-screen">
    <a href="" class="-intro-x flex items-center pt-5">
        <img alt="Dashboard BNPP" class="w-6" src="{{asset('assets')}}/back/images/logo.svg">
        <span class="text-white text-lg ml-3"> Mid<span class="font-medium">One</span> </span>
    </a>
    <div class="my-auto">
        <img alt="Dashboard BNPP" class="-intro-x w-1/2 -mt-16" src="{{asset('assets')}}/back/images/illustration.svg">
