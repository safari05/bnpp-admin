            ...
            <div class="grid grid-cols-12 gap-6 mt-5">
                <div class="col-span-12 intro-y">
                    <div class="grid grid-cols-12 gap-2">
                        <input type="text" class="input w-full border col-span-10" placeholder="Nama Aset" name="name" id="name">
    ...
    <div class="modal__content p-10 text-center">
        <div class="grid grid-cols-12 gap-6">
            ...
            <div class="col-span-12 text-center">
                <input type="text" class="input w-full border" placeholder="Nama Aset" name="input-nama" id="input-nama">
            </div>
...
<script>
    ...
    function tambahAset(){
        ...
        $('#btn-simpan-aset').on('click', function(){
            ...
            console.log(data);
            $.post('{{route('master.aset.store')}}', data, res=>{
                if (res.status == 200) {
                    refreshTable();
                    showSuccess(res.msg);
                } else {
    ...
    function hapusAset(id){
        Swal.fire({
            title: 'Hapus Aset',
            text: 'Aset yang dihapus tidak dapat dikembalikan. Lanjutkan?',
            ...
            if (result.isConfirmed) {
                ...
                $.post('{{url('master/aset/delete')}}/'+id, data, res=>{
                    if (res.status == 200) {
                        refreshTable();
                        showSuccess(res.msg);
                    } else {
