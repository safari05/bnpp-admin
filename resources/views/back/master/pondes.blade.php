            ...
            <div class="grid grid-cols-12 gap-6 mt-5">
                <div class="col-span-12 intro-y">
                    <div class="grid grid-cols-12 gap-2">
                        <input type="text" class="input w-full border col-span-10" placeholder="Nama Potensi Desa" name="name" id="name" tabindex="1">
    ...
    <div class="modal__content p-10 text-center">
        <div class="grid grid-cols-12 gap-6">
            <div class="col-span-12">
                <h3>Tambah Potensi Desa</h3>
            </div>
            <div class="col-span-12 text-center">
                <input type="text" class="input w-full border" placeholder="Nama Potensi Desa" name="input-nama" id="input-nama">
            </div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $.getJSON('{{route('master.pondes.source')}}', data=>{
            $( "#name" ).autocomplete({
                source: data
            });
        })
    ...
    function tambahAset(){
        ...
        $('#btn-simpan-aset').on('click', function(){
            ...
            console.log(data);
            $.post('{{route('master.pondes.store')}}', data, res=>{
                if (res.status == 200) {
                    refreshTable();
                    showSuccess(res.msg);
                } else {
    ...
    function hapusAset(id){
        Swal.fire({
            ...
            text: 'Potensi Desa yang dihapus tidak dapat dikembalikan. Lanjutkan?',
            ...
            if (result.isConfirmed) {
                ...
                $.post('{{url('master/pondes/delete')}}/'+id, data, res=>{
                    if (res.status == 200) {
                        refreshTable();
                        showSuccess(res.msg);
                    } else {
