...
<div class="-intro-x breadcrumb mr-auto hidden sm:flex">
    ...
    <i data-feather="chevron-right" class="breadcrumb__icon"></i> <a href="" class="breadcrumb--active">Kota</a>
</div>
@endsection
@section('content')
            ...
            <div class="grid grid-cols-12 gap-6 mt-5">
                <div class="col-span-12 intro-y">
                    <div class="grid grid-cols-12 gap-2">
                        ...
                        <input type="text" class="input w-full border col-span-4" placeholder="Nama Kota" name="name" id="name">
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('body').on('click', '.btn-deactive', function () {
            Swal.fire({
                title: 'Konfirmasi',
                text: 'Anda akan mendeaktivasi Kota. Lanjutkan?',
                ...
                if (result.isConfirmed) {
                    ...
                    $.post('{{route('master.kota.change')}}', data, res => {
                            if (res.status == 200) {
                                refreshTable();
                                showSuccess(res.msg);
                            } else {
        ...
        $('body').on('click', '.btn-active', function () {
            Swal.fire({
                title: 'Konfirmasi',
                text: 'Anda akan mengaktivasi Kota. Lanjutkan?',
                showCancelButton: true,
                confirmButtonText: 'Lanjutkan',
                cancelButtonText: 'Tutup',
            }).then((result) => {
