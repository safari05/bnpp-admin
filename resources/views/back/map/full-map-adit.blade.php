...
<link rel="stylesheet" type="css" href="https://unpkg.com/leaflet-routing-machine@latest/dist/leaflet-routing-machine.css" />
    ...
    <div class="floating-card">
        <div class="box m-2 p-3">
            ...
            <div class="grid grid-cols-12 gap-3 mt-2 filter-row d-none" id="filter-kec">
                ...
                <div class="col-span-12 mt-2"><h3 class="text-medium truncate mr-5">Tipe Kecamatan</h3></div>
                <div class="flex flex-col sm:flex-row col-span-12">
