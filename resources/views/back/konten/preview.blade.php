@extends('back.layout.preview-content')
...
{{--                                </div>--}}
                                ...
                                {{-- <div class="post-nav fl-wrap">
                                    <a href="{{ url('/berita/1') }}" class="post-link prev-post-link"><i class="fa fa-angle-left"></i>Sebelumnya <span class="clearfix">Pelayanan PBN melalui PLBN Wini NTT</span></a>
                                    <a href="{{ url('/berita/1') }}" class="post-link next-post-link"><i class="fa fa-angle-right"></i>Selanjutnya<span class="clearfix">Pengelolaan Perbatasan Oleh BNPP RI </span></a>
                                </div> --}}
                            </div>
                        </article>
                        <!-- article end -->
